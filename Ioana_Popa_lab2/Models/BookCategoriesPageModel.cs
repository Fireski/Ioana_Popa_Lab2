...
namespace Ioana_Popa_lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Ioana_Popa_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Ioana_Popa_Lab2Context context,
